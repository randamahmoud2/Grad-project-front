  ...
  <table className="table1" style={{border: "none"}}>
      <tbody>
            ...
            <tr className="furca">
                ...
                <td>
                    <div onClick={() => cycleFurca(`_d48${props.id}`)} id={`furca_d48${props.id}`} className="box"></div>
                    <div onClick={() => cycleFurca(`_m48${props.id}`)} id={`furca_m48${props.id}`} className="box"></div>
                </td>
                <td>
                    <div onClick={() => cycleFurca(`_d47${props.id}`)} id={`furca_d47${props.id}`} className="box"></div>
                    <div onClick={() => cycleFurca(`_m47${props.id}`)} id={`furca_m47${props.id}`} className="box"></div>
                </td>
                <td>
                    <div onClick={() => cycleFurca(`_d46${props.id}`)} id={`furca_d46${props.id}`} className="box"></div>
                    <div onClick={() => cycleFurca(`_m46${props.id}`)} id={`furca_m46${props.id}`} className="box"></div>
                </td>
                ...
                <td></td>
                <td>
                  <div onClick={() => cycleFurca(`_m36${props.id}`)} id={`furca_m36${props.id}`} className="box"></div>
                  <div onClick={() => cycleFurca(`_d36${props.id}`)} id={`furca_d36${props.id}`} className="box"></div>
                </td>
                <td>
                  <div onClick={() => cycleFurca(`_m37${props.id}`)} id={`furca_m37${props.id}`} className="box"></div>
                  <div onClick={() => cycleFurca(`_d37${props.id}`)} id={`furca_d37${props.id}`} className="box"></div>
                </td>
                <td>
                  <div onClick={() => cycleFurca(`_m38${props.id}`)} id={`furca_m38${props.id}`} className="box"></div>
                  <div onClick={() => cycleFurca(`_d38${props.id}`)} id={`furca_d38${props.id}`} className="box"></div>
                </td>
            </tr>
